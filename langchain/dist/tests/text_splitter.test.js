...
import { CharacterTextSplitter, MarkdownTextSplitter, LatexTextSplitter, RecursiveCharacterTextSplitter, TokenTextSplitter, } from "../text_splitter.js";
...
test("Test create documents method with metadata and an added chunk header.", async () => {
    ...
    const docs = await splitter.createDocuments(texts, [{ source: "1" }, { source: "2" }], {
