...
test("Pinecone Store Self Query Retriever Test", async () => {
    ...
    if (!process.env.PINECONE_API_KEY ||
        ...
        throw new Error("PINECONE_ENVIRONMENT and PINECONE_API_KEY and PINECONE_INDEX must be set");
    }
    ...
    const query4 = await selfQueryRetriever.getRelevantDocuments("Which movies are either comedy or drama and are less than 90 minutes?");
