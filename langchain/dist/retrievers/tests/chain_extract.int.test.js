...
test("Test LLMChainExtractor", async () => {
    ...
    const retriever = new ContextualCompressionRetriever({
        baseCompressor,
        baseRetriever: await HNSWLib.fromTexts(["Hello world", "Bye bye", "hello nice world", "bye", "hi"], [{ id: 2 }, { id: 1 }, { id: 3 }, { id: 4 }, { id: 5 }], new OpenAIEmbeddings()).then((vectorStore) => vectorStore.asRetriever()),
    });
