...
import { ConstitutionalChain, ConstitutionalPrinciple, LLMChain, } from "../../chains/index.js";
...
test("Test LangChain V2 tracer", async () => {
    ...
    await tracer.handleChatModelStart(serialized, [[new HumanChatMessage("I'm a human.")]], chatRunId);
...
test("Test traced chain with tags", async () => {
    ...
    }, [new LangChainTracer()], ["test-for-tags"]);
});
