...
test("Test Unstructured base loader legacy syntax", async () => {
    ...
    const loader = new UnstructuredLoader("https://api.unstructured.io/general/v0/general", filePath);
...
test("Test Unstructured directory loader legacy syntax", async () => {
    ...
    const loader = new UnstructuredDirectoryLoader("https://api.unstructured.io/general/v0/general", directoryPath, true, UnknownHandling.Ignore);
    const docs = await loader.load();
