...
import { PromptTemplate, ChatPromptTemplate, AIMessagePromptTemplate, HumanMessagePromptTemplate, SystemMessagePromptTemplate, } from "../../prompts/index.js";
...
test("Test ChatAnthropic in streaming mode with a signal", async () => {
    ...
    const controller = new AbortController();
    const message = new HumanChatMessage("Hello! Give me an extremely verbose response");
    await expect(() => {
